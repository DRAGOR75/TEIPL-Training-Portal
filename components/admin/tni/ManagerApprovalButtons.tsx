    ...
    return (
        <div className="flex items-center gap-3 pl-5 md:pl-0 border-t md:border-t-0 border-slate-100 pt-4 md:pt-0">
            <button
                ...
                disabled={isUpdating}
                className="flex items-center gap-2 px-4 py-2.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-red-50 hover:text-red-700 hover:border-red-200 font-bold text-sm transition-all focus:ring-2 focus:ring-red-200 focus:outline-none disabled:opacity-50"
            >
            ...
            <button
                ...
                disabled={isUpdating}
                className="flex items-center gap-2 px-6 py-2.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 font-bold text-sm transition-all shadow-md hover:shadow-lg shadow-indigo-600/20 active:scale-95 focus:ring-2 focus:ring-indigo-200 focus:outline-none disabled:opacity-50"
            >
                {isUpdating ? <HiOutlineArrowPath className="animate-spin" size={16} /> : <HiOutlineCheck size={16} strokeWidth={3} />}
                Approve
            </button>
        </div>
    );
