...
async function main() {
    console.log("Starting script to update employeeGroup...");
    ...
    // 2. Fetch grades for ONLY those specific employees
    ...
    console.log(`Found ${employees.length} of those employees with an assigned grade.`);
