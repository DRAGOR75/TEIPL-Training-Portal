...
export default async function UserHubDashboardPage() {
            ...
            <div className="bg-white border-b border-slate-200 pt-16 pb-12">
                <div className="container mx-auto px-6 max-w-7xl">
                    <div className="flex flex-col items-start space-y-2 relative">
                        ...
                        <p className="text-slate-500 font-medium">Logged in as: <span className="text-slate-800 font-bold">{empId}</span></p>

                        <div className="absolute right-0 top-1/2 -translate-y-1/2">
                            <form action={logoutEmployee}>
                                <button type="submit" className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 hover:text-slate-900 text-sm font-bold rounded-xl transition-colors">
