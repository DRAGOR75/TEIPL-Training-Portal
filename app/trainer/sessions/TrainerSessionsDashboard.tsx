                    ...
                    <div className="bg-white rounded-3xl shadow-air border border-slate-100 p-4 md:p-6">
                        ...
                        <div className="calendar-wrapper">
                            ...
                            <div className="mt-6 pt-4 border-t border-slate-100">
                                <Link href="/calendar" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-2.5 px-4 bg-slate-50 hover:bg-blue-50 text-slate-600 hover:text-blue-700 font-semibold text-sm rounded-xl transition-colors border border-slate-200 hover:border-blue-200">
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 w-full space-y-4">
                                            ...
                                            <div className="pt-2 flex flex-col md:flex-row gap-3">
                                                <button onClick={(e) => { e.stopPropagation(); router.push(`/trainer/sessions/${session.id}/manage`); }} className="flex-1 px-6 flex items-center justify-center gap-2 bg-white border border-slate-200 hover:border-blue-400 hover:text-blue-600 text-slate-700 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm active:scale-95 group/btn">
                                                    Manage Session
